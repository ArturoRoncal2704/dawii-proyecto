...
import org.cibertec.service.EstadoMesaService;
...
public class EstadoMesaController {
    ...
    public ResponseEntity<?> registrarEstadoMesa(@RequestBody EstadoMesa estadoMesa) {
        try {
            EstadoMesa creado = estadoMesaService.registrarEstadoMesa(estadoMesa);
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> actualizarEstadoMesa(
            @PathVariable Integer id,
            @RequestBody EstadoMesa estadoMesa) {
        try {
            estadoMesaService.actualizarEstadoMesa(id, estadoMesa);
